...
values
  (
    ...
    'owner@mavapos.test',
    'replace-with-scrypt-or-bcrypt-hash',
    now()
  ),
  (
...
insert into public.products (id, outlet_id, category_id, name, price, cost_price, stock, tag, image_url)
values
  ('00000000-0000-4000-8000-000000000201', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000101', 'Nasi Ayam Geprek', 18000, 11000, 18, 'Terlaris', 'https://images.unsplash.com/photo-1562967916-eb82221dfb92?auto=format&fit=crop&w=600&q=80'),
  ('00000000-0000-4000-8000-000000000202', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000101', 'Es Kopi Susu', 16000, 6500, 24, 'Promo', 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?auto=format&fit=crop&w=600&q=80'),
  ('00000000-0000-4000-8000-000000000203', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000101', 'Mie Goreng Spesial', 22000, 13000, 11, 'Dapur', 'https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?auto=format&fit=crop&w=600&q=80'),
  ('00000000-0000-4000-8000-000000000204', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000102', 'Roti Cokelat', 8500, 5000, 6, 'Stok tipis', 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=600&q=80'),
  ('00000000-0000-4000-8000-000000000205', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000102', 'Air Mineral 600ml', 5000, 2800, 42, 'Cepat', 'https://images.unsplash.com/photo-1523362628745-0c100150b504?auto=format&fit=crop&w=600&q=80'),
  ('00000000-0000-4000-8000-000000000206', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000102', 'Snack Kentang', 12000, 7000, 15, 'Barcode', 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?auto=format&fit=crop&w=600&q=80')
on conflict (id) do update set
  outlet_id = excluded.outlet_id,
...
insert into public.staff_members (id, outlet_id, user_id, name, role, phone, shift, status)
values
  ('00000000-0000-4000-8000-000000000501', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000902', 'Ayu Lestari', 'Kasir', '0812-3456-7788', 'Pagi', 'Aktif'),
  ('00000000-0000-4000-8000-000000000502', '00000000-0000-4000-8000-000000000001', null, 'Rafi Pratama', 'Kasir', '0812-8899-1100', 'Sore', 'Aktif')
on conflict (id) do update set
